...
class _TopUpState extends State<TopUp> {
  ...
  Future<String> getDatas() async {
    ...
    var response = await http.get(
        Uri.encodeFull("https://spenn.herokuapp.com/topupapi/"),
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: _sendToField('Phone number'),
                        ),
                        Container(
                          padding: EdgeInsets.all(8.0),
  ...
  void _sendMoney() async {
    ...
    var data = {
      ...
      'sender': username,
      'receivernumber': sendToController.text
    };
//
    var res = await CallApi().sendMoney(data, 'topupapi/');
