...
class _WalletState extends State<Wallet> {
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Container(
            child: Column(
              children: [
                _buildSendCard('saving', 'FRW 10000'),
                SizedBox(
                  height: 10.0,
                ),
                Container(
  ...
  void _sendMoney() async {
    ...
    var data = {
      ...
      'sender': username,
      'receiver': sendToController.text
    };
//
    var res = await CallApi().sendMoney(data, 'moneysendapi/');
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("Top Up "),
            content: Text("Money have been topped up!"),
          );
        });
  }
}

Widget _buildSendCard(String title, String amount) {
  return Center(
    child: SizedBox(
...
Widget _buildTopupCard(String title, String amount) {
  return Center(
    child: SizedBox(
      height: 120, // card height
      child: Card(
